package com.pp.springboot200102.common.shiro;

import com.pp.springboot200102.common.util.ShiroUtils;
...
import com.pp.springboot200102.core.service.SysMenuService;
import com.pp.springboot200102.core.service.SysRoleService;
...
//        SysUserEntity sysUserEntity =(SysUserEntity) principalCollection.getPrimaryPrincipal();
        SysUserEntity sysUserEntity = principalCollection.oneByType(SysUserEntity.class);
